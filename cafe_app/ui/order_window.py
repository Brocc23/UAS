...
class OrderWindow:
    def __init__(self, master):
        ...
        self.menu_list.column("nama", width=180)
        ...
        ttk.Entry(input_box, textvariable=self.jumlah_var, width=10).grid(row=0, column=1)
        ...
        self.order_table.column("nama", width=200)
    ...
    def load_menu(self):
        ...
        for m in data:
            self.menu_list.insert("", "end", values=(m[1], m[2], m[3], m[4]))
